...
go_to_genes = {}
go_to_description = {}
with open("/Users/sophiekearney/Desktop/graph/parsed_GO_pval/GO_human_rel.csv") as f:
    lines = f.readlines()
...
with open("/Users/sophiekearney/Desktop/graph/hh_vv_relationships.csv", "w", newline="") as f:
